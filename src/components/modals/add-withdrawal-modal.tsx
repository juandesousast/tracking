...
export function AddWithdrawalModal({
  ...
  return (
    <ResponsiveModal
      ...
      title="Registrar Retiro de Ganancias"
      description="Registra un nuevo retiro ejecutado o pendiente."
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="space-y-1.5">
            <Label htmlFor="w-firm" className="text-xs font-medium">
              Empresa de Fondeo
            </Label>
            <select
              id="w-firm"
          ...
          <div className="space-y-1.5">
            <Label htmlFor="w-account" className="text-xs font-medium">
              Cuenta Asociada
            </Label>
            <select
              id="w-account"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="space-y-1.5">
            <Label htmlFor="w-gross" className="text-xs font-medium">
              Monto Bruto (USD) *
            </Label>
            <Input
              id="w-gross"
          ...
          <div className="space-y-1.5">
            <Label htmlFor="w-fee" className="text-xs font-medium">
              Fee / Comisión (USD)
            </Label>
            <Input
              id="w-fee"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="space-y-1.5">
            <Label htmlFor="w-status" className="text-xs font-medium">
              Estado del Retiro
            </Label>
            <select
              id="w-status"
          ...
          <div className="space-y-1.5">
            <Label htmlFor="w-date" className="text-xs font-medium">
              Fecha *
            </Label>
            <Input
              id="w-date"
